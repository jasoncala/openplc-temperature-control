...
const Entry debug_arr_0[3] STRUCPP_DEBUG_FLASH = {
    { (void*)&g_config.MAININSTANCE.TESTINPUT, TAG_BOOL, 0 },  // MAININSTANCE.TESTINPUT
    { (void*)&g_config.MAININSTANCE.ENABLE, TAG_BOOL, 0 },  // MAININSTANCE.ENABLE
    { (void*)&g_config.MAININSTANCE.TESTOUTPUT, TAG_BOOL, 0 },  // MAININSTANCE.TESTOUTPUT
};
