...
public:
    // Local variables
    IEC_UINT TEMPERATURE;  // AT %MW0
    IEC_BOOL FAN;  // AT %QX0.0
    ...
    void located_range(uint32_t* __off, uint32_t* __cnt) const override { *__off = 0; *__cnt = 2; }
#endif
};
...
// Forward: TEMPERATURE AT %MW0 in Program_MAIN
// Forward: FAN AT %QX0.0 in Program_MAIN
