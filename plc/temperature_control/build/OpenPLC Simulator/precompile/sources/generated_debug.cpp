...
const Entry debug_arr_0[2] STRUCPP_DEBUG_FLASH = {
    { (void*)&g_config.MAININSTANCE.TEMPERATURE, TAG_UINT, 0 },  // MAININSTANCE.TEMPERATURE
    { (void*)&g_config.MAININSTANCE.FAN, TAG_BOOL, 0 },  // MAININSTANCE.FAN
};
